	...
	if ( $option['type'] == 'upload' ) {
		...
		<div class="upload-input input-parent"<?php echo strlen($style) ? ' style="'.esc_attr($style).'"' : ''; ?>>
			...
			<div class="input-desc">
				...
				?> />
				<input id="clear_<?php echo esc_attr($input_prefix . $option['id']); ?>" class="clear-image-button" type="button" value="<?php echo esc_attr( esc_html__( 'Clear field', 'rife-free' )) ?>" />
