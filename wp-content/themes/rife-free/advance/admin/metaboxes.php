        ...
        elseif ( $meta['type'] === 'multi-upload' ) { ?>
	        ...
	        <div class="a13-mu-container">
                ...
                <p class="inline-part disabled" id="a13_multi_tags">
                    ...
                    <input class="button tagadd" value="<?php esc_html_e( 'Add', 'rife-free' ); ?>" type="button" disabled="disabled" />
                </p>
                <?php endif;
    ...
    if( isset( $_POST['post_type'] ) ){
        ...
        foreach( $meta_boxes as &$meta ){
            ...
            if( isset( $meta['id'] ) && isset( $_POST[ $input_prefix . $meta['id'] ] ) ){
                if( in_array( $meta['id'], $unslash_exceptions ) ){
                    $val =  wp_kses_post( $_POST[ $input_prefix . $meta['id'] ] );
                }
                elseif( in_array( $meta['id'], $sanitization_exceptions ) ){
                    $val = wp_kses_post( wp_unslash( $_POST[ $input_prefix . $meta['id'] ] ) );
                }
                else{
