...
function apollo13framework_page_preloader_css() {
	...
	global $apollo13framework_a13, $wp_filesystem;
    ...
    $prelaoder_bg_image_fit
		...
		if ( $prelaoder_type !== 'none' ) {
			...
			if( $can_process_file ){
				...
				if($wp_filesystem->exists( $preloader_css_file )) {
					$content = $wp_filesystem->get_contents( $preloader_css_file );
				}
			}
...
if(!function_exists('apollo13framework_search_form')){
	...
	function apollo13framework_search_form(
        ...
        $field_search = '<input' .
            ' placeholder="' . esc_attr( esc_html__('Search &hellip;', 'rife-free' )) . '" ' .
        ...
        $form = '
                <form class="search-form" role="search" method="get" action="' . esc_url( home_url( '/' ) ) . '" >
                    <fieldset class="semantic">
                        ' . $field_search . '
                        <input type="submit" id="searchsubmit' . $search_id . '" title="'. esc_attr( esc_html__( 'Search', 'rife-free' ) ) .'" value="'. esc_attr( esc_html__( 'Search', 'rife-free' ) ) .'" />
