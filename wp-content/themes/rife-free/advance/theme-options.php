	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'type'        => 'radio',
				'title'       => esc_html__( 'Footer unravel effect', 'rife-free' ),
				'description' => esc_html__( 'Works only with horizontal header. It makes footer fixed to bottom, but hidden under main content, so when you scroll down to footer it unravels its self.', 'rife-free' ),
				'options'     => $on_off,
				'default'     => 'off',
				'required'    => array(
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'default' => $apollo13framework_a13->get_option( 'titles_fonts' ),//default to titles fonts as it was in previous versions
			),
		)
	) );
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			array(
				...
				'type'        => 'color',
				'title'       => esc_html__( 'Background color', 'rife-free' ),
				'description' => esc_html__( 'It will change default white background color that is set under content on pages, blog, posts, works etc.', 'rife-free' ),
				'default'     => '#ffffff',
			),
			array(
				'id'      => 'content_color',
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'description' => esc_html__( 'Works only in horizontal header. Max allowed width of logo on mobile devices.', 'rife-free' ),
				'min'         => 25,
				'max'         => 250,
				'step'        => 1,
				'unit'        => 'px',
			...
			array(
				...
				'description' => wp_kses( __( 'If you use more then one word in logo, then you might want to use <code>&amp;nbsp;</code> instead of white space, so words wont break in many lines.', 'rife-free' ), $valid_tags ).'<br />'.sprintf( wp_kses( __( 'If you want to change Font for logo go to <a href="%s">Font settings</a>.', 'rife-free' ), $valid_tags ), 'javascript:wp.customize.control( \''.A13FRAMEWORK_OPTIONS_NAME.'[logo_fonts]\' ).focus();' ),
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'type'    => 'spacing',
				'title'   => esc_html__( 'Logo padding', 'rife-free' ),
				'mode'    => 'padding',
				'sides'   => array( 'top', 'bottom' ),
				'units'   => array( 'px', 'em' ),
				'default' => array(
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'type'        => 'radio',
				'title'       => esc_html__( 'Navigate by categories', 'rife-free' ),
				'description' => esc_html__( 'If enabled then navigation in single album will lead to next/previous work in same category. If disabled then it will navigate through albums by adding date order.', 'rife-free' ),
				'options'     => $on_off,
				'default'     => 'off',
...
//CUSTOM CSS
	$apollo13framework_a13->set_sections( array(
		'title'         => esc_html__( 'Custom CSS', 'rife-free' ),
		'desc'          => '',
...
//ADD SIDEBARS
	$apollo13framework_a13->set_sections( array(
		'title'         => esc_html__( 'Add custom Sidebars', 'rife-free' ),
		'desc'          => esc_html__( 'You can add here custom sidebars that can be used on pages for example.', 'rife-free' ),
		'id'            => 'section_sidebars',
		'icon'          => 'fa fa-columns',
		'priority'      => 10,
		'without_panel' => true,
...
//MISCELLANEOUS
	...
	$apollo13framework_a13->set_sections( array(
		'title'      => esc_html__( 'Address bar', 'rife-free' ),
		'desc'       => '',
